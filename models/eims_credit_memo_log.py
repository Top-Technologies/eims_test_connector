...
class EIMSCreditMemoLog(models.Model):
    _name = 'eims.credit.memo.log'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = 'EIMS Credit Memo Log'
    _rec_name = 'credit_memo_irn'
    ...
    credit_memo_id = fields.Many2one(
        'account.move', string="Credit Memo", ondelete='cascade',
        help="Linked Credit Memo"
    )
    ...
    credit_memo_irn = fields.Char("Credit Memo IRN")
    ...
    def action_verify_credit_memo_from_log(self):
        for record in self:
